    ...
    implements Serializable
{
    ...
    public void initialize(int index, WorldState w)
    {
        ...
        if(index != 34)
            break MISSING_BLOCK_LABEL_2119;
        name = "Impregnation";
        prereqsRequired = 2;
        cost = 40;
        prereqs = (new Tech[] {
...
_L1:
        this;
        description;
        JVM INSTR new #332 <Class StringBuilder>;
        JVM INSTR dup_x1 ;
        JVM INSTR swap ;
        String.valueOf();
        StringBuilder();
...
_L2:
        ...
        if(index != 36)
            break MISSING_BLOCK_LABEL_2312;
        name = "Drain";
        prereqsRequired = 2;
        cost = 40;
        prereqs = (new Tech[] {
