    ...
    implements Serializable
{
    ...
    public void assignTooltip(int index, WorldState w)
    {
        ...
        this;
        tooltip;
        JVM INSTR new #48  <Class StringBuilder>;
        JVM INSTR dup_x1 ;
        JVM INSTR swap ;
        String.valueOf();
        StringBuilder();
    ...
    public void initialize(int index, WorldState w)
    {
        if(index == 0)
        {
            ...
            break MISSING_BLOCK_LABEL_3356;
        }
        if(index == 1)
        {
        ...
        String.valueOf();
        StringBuilder();
        "  This upgrade also allows you to manage the Forsaken brought from previous loops.";
        append();
        toString();
        description;
        break MISSING_BLOCK_LABEL_3356;
        ...
        if(index != 34)
            break MISSING_BLOCK_LABEL_2187;
        name = "Impregnation";
        prereqsRequired = 2;
        cost = 40;
        prereqs = (new Tech[] {
...
_L2:
        ...
        if(index == 40)
        {
            ...
            cost = 100;
            prereqs = (new Tech[] {
                w.getTechs()[31], w.getTechs()[34], w.getTechs()[38]
            });
        ...
        if(index == 41)
        {
            ...
            cost = 100;
            prereqs = (new Tech[] {
                w.getTechs()[30], w.getTechs()[35], w.getTechs()[39]
            });
        ...
        if(index == 42)
        {
            ...
            description = "Perfects your telepathic abilities, allowing you to influence the Chosen by showing them frightening visions of what could be.  This doubles the damage of the Threaten action.  Additionally, during the final battle, the Threaten action will decrease the target's Resolve by a base value of 3% per ally suffering from Demonic impregnation.  The decrease is multiplied by the target's FEAR level.";
            break MISSING_BLOCK_LABEL_3356;
        }
        if(index == 43)
        {
            ...
            description = "Perfects the potency of your slime, allowing it to pull the Chosen into the Demonic hivemind.  This doubles the damage of the Slime action.  Additionally, during the final battle, the Slime action will decrease the Resolve of Hypnotized targets by 4%.  The decrease is multiplied by the target's DISG level.";
            break MISSING_BLOCK_LABEL_3356;
        }
        if(index != 44)
            break MISSING_BLOCK_LABEL_3060;
        ...
        description = (new StringBuilder("Perfects the combat ability of your Demons, allowing them to torture the Chosen with extreme precision.  This doubles the damage of the ")).append(actionName).append(" action.  Additionally, during the final battle, the ").append(actionName).append(" action will decrease the Resolve of Drained targets by 3%, or non-Drained targets by 1%.  This decrease is multiplied by the target's ").toString();
        if(!w.tickle().booleanValue())
            break MISSING_BLOCK_LABEL_3029;
        this;
        description;
        JVM INSTR new #48  <Class StringBuilder>;
        JVM INSTR dup_x1 ;
        ...
        if(index == 46)
        {
            ...
            cost = 100;
            prereqs = (new Tech[] {
                w.getTechs()[29], w.getTechs()[36], w.getTechs()[38]
            });
        ...
        if(index == 47)
        {
            ...
            cost = 100;
            prereqs = (new Tech[] {
                w.getTechs()[28], w.getTechs()[37], w.getTechs()[39]
            });
        ...
        if(index == 48)
        {
            ...
            cost = 300;
            prereqs = (new Tech[] {
                w.getTechs()[42], w.getTechs()[43], w.getTechs()[44], w.getTechs()[45]
            });
