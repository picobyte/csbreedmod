...
public class Project extends JFrame {
	...
	public static void NewMeeting(final JTextPane t, final JPanel p, final JFrame f, final WorldState w, final SaveData s, final Body[] participants, Activity.Location spot) {
		if (participants[0].chosenOwner == null && participants[0].forsakenOwner == null) {
	...
	public static void PickAction (final JTextPane t, final JPanel p, final JFrame f, final WorldState w, final Chosen c, final Chosen[] initiative) {
		...
		final Action AppealAction = new AppealButton("Appeal", "Use Appeal");
