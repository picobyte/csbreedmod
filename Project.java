...
public class Project extends JFrame {
	...
	final static int scenesThisVersion = 49;
	final static int vignettesThisVersion = 16;
	final static Color PURPLISH = new Color(225, 125, 255);
	...
	public static Activity Talk = new Activity();
	public static Activity TweakClit = new Activity();
	public static Activity ClitTweaked = new Activity();
	public static Activity SpreadLegs = new Activity();
	public static Activity Praise = new Activity();
	public static Activity Insult = new Activity();
	public static Activity PushDown = new Activity();
	public static Activity PullDown = new Activity();
	public static Activity Escape = new Activity();
	public static Activity StopActing = new Activity();
	public static Activity TieUp = new Activity();
	public static Activity BeTied = new Activity();
	public static Activity StrokeCock = new Activity();
	public static Activity CockStroked = new Activity();
	public static Activity Lubricate = new Activity();
	public static Activity BeLubricated = new Activity();
	public static Activity VaginalPenetrate = new Activity();
	public static Activity PenetratedVaginally = new Activity();
	public static Activity AnalPenetrate = new Activity();
	public static Activity PenetratedAnally = new Activity();
	public static Activity StripOther = new Activity();
	public static Activity Stripped = new Activity();
	public static Activity LickCock = new Activity();
	public static Activity CockLicked = new Activity();
	public static Activity LickPussy = new Activity();
	public static Activity PussyLicked = new Activity();
	public static Activity Supine = new Activity();
	public static Activity PullUp = new Activity();
	public static Activity StepOnCock = new Activity();
	public static Activity CockSteppedOn = new Activity();
	public static Activity StepOnClit = new Activity();
	public static Activity ClitSteppedOn = new Activity();
	public static Activity DirtyTalk = new Activity();
	public static Activity[] allActivities = new Activity[]{Talk, TweakClit, ClitTweaked, 
			SpreadLegs, Praise, Insult, PushDown, PullDown, Escape, StopActing, TieUp, BeTied,
			StrokeCock, CockStroked, Lubricate, BeLubricated, VaginalPenetrate, 
			PenetratedVaginally, AnalPenetrate, PenetratedAnally, StripOther, Stripped,
			LickCock, CockLicked, LickPussy, PussyLicked, Supine, PullUp, StepOnCock, 
			CockSteppedOn, StepOnClit, ClitSteppedOn, DirtyTalk};
	//short description, start activity, end activity, activity talk, initialize activities
	//name, weight, damage, any special valid conditions for player and partner
	...
	public static void CampaignMenu(JTextPane t, JPanel p, JFrame f, WorldState w, Boolean[] enabled) {
		p.removeAll();
		clearPortraits();
		...
		if (w.save.customRoster.length == 0) {
			...
			Toggle.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					CampaignCustomToggle(t, p, f, w, enabled, 0, false);
				}
			});
			p.add(Toggle);
			...
			DeleteChosen.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					CampaignCustomToggle(t, p, f, w, enabled, 0, true);
				}
			});
			p.add(DeleteChosen);
		}
		...
		SoloGen.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Chosen c = new Chosen();
				int[] nameSeed = new int[]{(int)(Math.random()*26), (int)(Math.random()*26), 0, 0, 0, 0};
	...
	public static void ImportMenu(JTextPane t, JPanel p, JFrame f, WorldState w, Boolean[] enabled, int page) {
		p.removeAll();
		int i = page*4;
		int j = 0;
		...
		if (foundRosters.length == 0) {
			...
			if (page > 0) {
				...
				LastPage.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						ImportMenu(t, p, f, w, enabled, page-1);
					}
				});
				p.add(LastPage);
			}
			while (i < foundRosters.length && j < 4) {
				...
				Access.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						CampaignMenu(t, p, f, w, newEnabled);
					}
				});
				p.add(Access);
				i++;
	...
	public static void SingleCustom(JTextPane t, JPanel p, JFrame f, WorldState w, Chosen c, int[] answers) {
		p.removeAll();
		...
		FamilyName.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SingleCustom(t, p, f, w, c, answers);
			}
		});
		p.add(FamilyName);
		...
		NameOrder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				c.filthyGaijin = (c.filthyGaijin == false);
				SingleCustom(t, p, f, w, c, answers);
			}
		});
		p.add(NameOrder);
		...
		Continue.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (answers == null) {
					CustomQuiz(t, p, f, w, c, 0, new int[32]);
				} else {
					CustomQuiz(t, p, f, w, c, 0, answers);
				}
			}
		});
		p.add(Continue);
					...
					if (value >= 0 && value <= 100) {
						...
						if (value >= 0 && value <= 100 && ((value >= lowerLimit && value <= upperLimit) || (upperLimit < lowerLimit && (value > 66 || value < 34)))) {
							...
							if (highFound == false) {
								upperLimit = 100;
								lowerLimit = 67;
							} else if (midFound == false) {
								upperLimit = 66;
								lowerLimit = 34;
							} else if (lowFound == false) {
								upperLimit = 33;
								lowerLimit = 0;
							} else {
								upperLimit = 100;
							...
							if (value >= lowerLimit && value <= upperLimit) {
								c.dignity = value;
								if (w.determineVVirg(c.morality, c.innocence, c.confidence, c.dignity) == false) {
									c.ruthless = true;
									c.vVirg = false;
									c.vStart = false;
									c.vTaker = 0;
								...
								if (w.determineCVirg(c.morality, c.innocence, c.confidence, c.dignity) == false) {
									c.lustful = true;
									c.cVirg = false;
									c.cStart = false;
									c.cTaker = 0;
								...
								if (w.determineAVirg(c.morality, c.innocence, c.confidence, c.dignity) == false) {
									c.meek = true;
									c.aVirg = false;
									c.aStart = false;
									c.aTaker = 0;
								...
								if (w.determineModest(c.morality, c.innocence, c.confidence, c.dignity) == false) {
									c.debased = true;
									c.modest = false;
									c.mStart = false;
									c.mTaker = 0;
								...
								SingleCosmetics(t, p, f, w, c, null);
							} else {
								w.append(t, "\n\n" + w.getSeparator() + "\n\nInvalid value.");
								SingleCustom(t, p, f, w, c, answers);
							}
	...
	public static void CustomQuiz(JTextPane t, JPanel p, JFrame f, WorldState w, Chosen c, int progress, int[] answers) {
		p.removeAll();
		w.append(t, "\n\n" + w.getSeparator() + "\n\n");
		/*if (progress == 0) {
			w.append(t, "This segment takes the form of a series of questions about how " + c.givenName + " thinks and behaves.  Pick the option that comes closest to how " + c.heShe() + " really is.\n\nQuestion 1: What does " + c.givenName + " think of the general public?");
		} else if (progress == 1) {
			w.append(t, "Question 2: What is " + c.givenName + "'s first instinct when " + c.heShe() + " sees someone in danger?");
		} else if (progress == 2) {
			w.append(t, "Question 3: How would " + c.givenName + " prefer to be viewed by others?");
		} else if (progress == 3) {
			w.append(t, "Question 4: When someone disagrees with " + c.givenName + ", how does " + c.heShe() + " respond?");
		} else if (progress == 4) {
			w.append(t, "Question 5: What does " + c.givenName + " think of having a fanbase devoted to " + c.himHer() + "?");
		} else if (progress == 5) {
			w.append(t, "Question 6: How does " + c.givenName + " deal with compliments?");
		} else if (progress == 6) {
			w.append(t, "Question 7: What does " + c.givenName + " think about good and evil?");
		} else if (progress == 7) {
			w.append(t, "Question 8: Which of these does " + c.givenName + " think is " + c.hisHer() + " own biggest flaw?");
		} else if (progress == 8) {
			w.append(t, "Question 9: How does " + c.givenName + " react in humiliating situations?");
		} else if (progress == 9) {
			w.append(t, "Question 10: How does " + c.givenName + " handle academic challenges?");
		} else if (progress == 10) {
			w.append(t, "Question 11: Is " + c.givenName + " a skillful liar?");
		} else if (progress == 11) {
			w.append(t, "Question 12: What is " + c.givenName + "'s position in " + c.hisHer() + " social circle?");
		} else if (progress == 12) {
			w.append(t, "Question 13: What kind of impact does " + c.givenName + " have on the lives of those around " + c.himHer() + ".");
		} else if (progress == 13) {
			w.append(t, "Question 14: When does " + c.givenName + " resort to violence?");
		} else if (progress == 14) {
			w.append(t, "Question 15: What does " + c.givenName + " do after learning " + c.heShe() + " hurt someone?");
		} else if (progress == 15) {
			w.append(t, "Question 16: What is most effective at making " + c.givenName + " lose " + c.hisHer() + " composure?");
		} else if (progress == 16) {
			w.append(t, "Question 17: How does " + c.givenName + " prefer to get what " + c.heShe() + " wants from people?");
		} else if (progress == 17) {
			w.append(t, "Question 18: How does " + c.givenName + " react when someone damages " + c.hisHer() + " clothes?");
		} else if (progress == 18) {
			w.append(t, "Question 19: When does " + c.givenName + " enjoy seeing someone suffer?");
		} else if (progress == 19) {
			w.append(t, "Question 20: What is " + c.givenName + "'s main concern when fighting?");
		} else if (progress == 20) {
			w.append(t, "Question 21: What is " + c.givenName + "'s main concern when talking?");
		} else if (progress == 21) {
			w.append(t, "Question 22: What's the worst outcome " + c.givenName + " can imagine?");
		} else if (progress == 22) {
			w.append(t, "Question 23: If " + c.givenName + " weren't one of the Chosen, which of these jobs would fit " + c.hisHer() + " talents best?");
		} else if (progress == 23) {
			w.append(t, "Question 24: How does " + c.givenName + " react when defeated?");
		}*/
		if (progress == 0) {
		...
		if (progress == 0) {
			...
			//Selfishness Innocence Confidence
		} else if (progress == 13) {
			...
			//Selfishness Cunning Confidence
		} else if (progress == 25) {
			...
			//Selfishness Weakness Honesty
		} else if (progress == 31) {
			w.append(t, "1: Focus even more on not making any mistakes.\n2: Get flustered.\n3: Ignore them.");
			//Cunning Weakness Honesty
		}
		for (int i = 0; i < 3; i++) {
			int picked = i+1;
			JButton ThisAnswer = new JButton("" + picked);
			ThisAnswer.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					answers[progress] = picked;
					if (progress < 31) {
						CustomQuiz(t, p, f, w, c, progress+1, answers);
					} else {
						SinglePersonality(t, p, f, w, c, answers);
					}
				}
			});
			p.add(ThisAnswer);
		...
		Quit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Cancel.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						CustomQuiz(t, p, f, w, c, progress, answers);
					}
				});
				p.validate();
				p.repaint();
	...
	public static void SinglePersonality(JTextPane t, JPanel p, JFrame f, WorldState w, Chosen c, int[] answers) {
		...
		while (highs == 0 || mids == 0 || lows == 0) {
			...
			if (highs == 0) {
				...
				int flexibleStat = 0;
				for (int i = 0; i < 4; i++) {
					if ((stats[i] > 66 && highs > 1) || (stats[i] < 34 && lows > 1)) {
						if ((Math.abs(stats[i] - 50)*(36-certainties[i]) > greatestFlexibility)) {
							greatestFlexibility = (100-stats[i])*(36-certainties[i]);
							flexibleStat = i;
						}
					}
	...
	public static void SingleCosmetics(JTextPane t, JPanel p, JFrame f, WorldState w, Chosen c, int[] answers) {
		p.removeAll();
		if (c.mainName == null) {
			c.world = w;
			if (c.globalID == 0) {
		...
		Breaks.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SingleVulnerabilities(t, p, f, w, c, answers, 0);
			}
		});
		p.add(Breaks);
		...
		Cosmetics.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				SingleNameAndClothes(t, p, f, w, c, answers, 0);
			}
		});
		p.add(Cosmetics);
		JButton Back = new JButton("Back");
		Back.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (answers == null) {
					...
					CustomQuiz(t, p, f, w, c, 31, answers);
				}
			}
		});
		p.add(Back);
	...
	public static void SingleNameAndClothes(JTextPane t, JPanel p, JFrame f, WorldState w, Chosen c, int[] answers, int progress) {
		p.removeAll();
		w.append(t, "\n\n" + w.getSeparator() + "\n\n");
		if (progress == 0) {
			...
			p.add(GivenName);
			if (c.mainName.equals(c.familyName) == false && c.familyName.length() > 0) {
			...
			CurrentTitle.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SingleNameAndClothes(t, p, f, w, c, answers, 2);
				}
			});
			p.add(CurrentTitle);
			JButton SomethingElse = new JButton("Something Else");
			...
			Keep.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SingleNameAndClothes(t, p, f, w, c, answers, 3);
				}
			});
			p.add(Keep);
			...
			if (c.nounName.length() > 0) {
				result = c.nounName + " " + result;
			}
			if (c.adjectiveName.equals("none") == false) {
				result = c.adjectiveName + " " + result;
			}
			result = c.incantation + "  " + result + ", transform!";
			...
			Current.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SingleNameAndClothes(t, p, f, w, c, answers, 5);
				}
			});
			p.add(Current);
			JButton Change = new JButton("Change");
			Change.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (input !=  null) {
						if (input.equals(c.topDesc()) == false && input.length() > 0) {
							changed = true;
						}
					}
					if (changed) {
						c.topCover = input;
						c.accessory = "none";
						SingleNameAndClothes(t, p, f, w, c, answers, 4);
					} else {
						SingleNameAndClothes(t, p, f, w, c, answers, 5);
					}
				}
			...
			Current.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SingleNameAndClothes(t, p, f, w, c, answers, 7);
				}
			});
			p.add(Current);
			JButton Change = new JButton("Change");
			Change.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					Boolean changed = false;
					if (input !=  null) {
						if (input.equals(c.bottomDesc()) == false && input.length() > 0) {
							changed = true;
						}
					}
					if (changed) {
						c.bottomCover = input;
						c.accessory = "none";
						if (c.underType.equals("none") == false) {
							c.underType = "panties";
						}
						SingleNameAndClothes(t, p, f, w, c, answers, 6);
					} else {
						SingleNameAndClothes(t, p, f, w, c, answers, 7);
					}
				}
			...
			Current.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SingleNameAndClothes(t, p, f, w, c, answers, 8);
				}
			});
			p.add(Current);
			JButton Change = new JButton("Change");
			Change.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (input !=  null) {
						if (input.length() > 0) {
							if (c.feetType.equals(input) == false) {
								c.accessory = "none";
							}
							c.feetType = input;
						}
			...
			Keep.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SingleNameAndClothes(t, p, f, w, c, answers, 9);
				}
			});
			p.add(Keep);
			JButton Change = new JButton("Change");
			...
			Keep.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					SingleNameAndClothes(t, p, f, w, c, answers, 11);
				}
			});
			p.add(Keep);
			JButton Change = new JButton("Change");
			Change.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (input !=  null) {
						if (input.length() > 0) {
							if (c.weapon.equals(input) == false) {
								c.accessory = "none";
								changed = true;
							}
							c.weapon = input;
					...
					if (changed) {
						SingleNameAndClothes(t, p, f, w, c, answers, 10);
					} else {
						SingleNameAndClothes(t, p, f, w, c, answers, 11);
					}
				}
		...
		Back.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (progress-1 == 4 || progress-1 == 6 || progress-1 == 10) {
					SingleNameAndClothes(t, p, f, w, c, answers, progress-2);
				} else if (progress == 0) {
					SingleCosmetics(t, p, f, w, c, answers);
				} else {
					SingleNameAndClothes(t, p, f, w, c, answers, progress-1);
				}
			}
		});
	...
	public static void SingleVulnerabilities(JTextPane t, JPanel p, JFrame f, WorldState w, Chosen c, int[] answers, int progress) {
		p.removeAll();
		w.append(t, "\n\n" + w.getSeparator() + "\n\n");
		if (progress == 0) {
			if (c.morality > 66) {
		...
		if ((progress == 0 && c.vVirg) || (progress == 1 && c.cVirg) || (progress == 2 && c.aVirg) || (progress == 3 && c.modest)) {
			...
			Break.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					if (progress < 3) {
						SingleVulnerabilities(t, p, f, w, c, answers, progress+1);
					} else {
						SingleCosmetics(t, p, f, w, c, answers);
					}
				}
	...
	public static void CampaignCustomToggle(JTextPane t, JPanel p, JFrame f, WorldState w, Boolean[] enabled, int page, Boolean deleting) {
		p.removeAll();
		clearPortraits();
		...
		if (page > 0) {
			...
			Previous.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					CampaignCustomToggle(t, p, f, w, enabled, page-1, deleting);
				}
			});
			p.add(Previous);
		}
				...
				ThisOne.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if (deleting) {
							...
							Delete.addActionListener(new ActionListener() {
								public void actionPerformed(ActionEvent e) {
									...
									if (index == newEnabled.length && newEnabled.length % 5 == 0 && page != 0) {
										CampaignCustomToggle(t, p, f, w, newEnabled, page-1, true);
									} else {
										CampaignCustomToggle(t, p, f, w, newEnabled, page, true);
									}
									w.append(t, "\n\n" + w.getSeparator());
									ReportCustomInclusion(t, w, newEnabled);
								}
							});
							p.add(Delete);
							JButton Back = new JButton("Back");
							Back.addActionListener(new ActionListener() {
								public void actionPerformed(ActionEvent e) {
									CampaignCustomToggle(t, p, f, w, enabled, page, true);
								}
							});
							p.add(Back);
							p.validate();
	...
	public static void ForsakenMenu(JTextPane t, JPanel p, JFrame f, WorldState w, SaveData s, int page) {
		...
		PassTime.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (w.loopComplete || w.truceEnforced()) {
					p.removeAll();
		...
		if (w.active && w.loopComplete == false && w.truceEnforced() == false) {
	...
	public static void ForsakenChoice(JTextPane t, JPanel p, JFrame f, WorldState w, SaveData s, int page) {
		...
		for (int i = page*5; i < page*5+5; i++) {
			if (i < w.getHarem().length) {
				...
				if (w.active) {
					for (int j = 0; j < 3; j++) {
						if (w.getCast()[j] != null) {
							...
							} else if (w.getHarem()[i].obsessedWith(w.getCast()[j])) {
				...
				if (Spent.stamina >= 200 && Spent.motivation >= actualCost && (w.active == false || EEAvailable >= Spent.EECost())) {
					p.add(Choice);
				}
	...
	public static void ForsakenInteraction(JTextPane t, JPanel p, JFrame f, WorldState w, SaveData s, Forsaken x) {
		...
		} else if (x.defeatType == 6 && x.flavorObedience() > x.obedience) {
		...
		Meet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				participants[0].imprisoned = true;
				SelectBody(t, p, f, w, s, participants);
			}
		});
		if (w.active == false || x.visited == false) {
			p.add(Meet);
		}
	...
	public static void SelectBody(JTextPane t, JPanel p, JFrame f, WorldState w, SaveData s, Body[] participants) {
		p.removeAll();
		...
		Male.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				DecideLocation(t, p, f, w, s, newParticipants);
			}
		});
		p.add(Male);
		...
		Back.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (participants.length == 1 && participants[0].forsakenOwner != null) {
					ForsakenInteraction(t, p, f, w, s, participants[0].forsakenOwner);
				} else if (w.active) {
					Shop(t, p, f, w);
				} else {
					IntroOne(t, p, f, w);
	...
	public static void DecideLocation(JTextPane t, JPanel p, JFrame f, WorldState w, SaveData s, Body[] participants) {
		p.removeAll();
		...
		if (participants[1].forsakenOwner != null) {
			...
			Chamber.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					NewMeeting(t, p, f, w, s, participants, Activity.Location.CHAMBER);
				}
			});
			p.add(Chamber);
			...
			Stage.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					NewMeeting(t, p, f, w, s, participants, Activity.Location.STAGE);
				}
			});
			p.add(Stage);
		} else if (participants[1].chosenOwner != null) {
			if (participants[1].chosenOwner.negotiations > 3 && participants[1].chosenOwner.ANGST >= Project.billion) {
				JButton Room = new JButton(participants[1].HisHer() + " Room");
				Room.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						NewMeeting(t, p, f, w, s, participants, Activity.Location.ROOM);
					}
				});
				p.add(Room);
			}
			...
			Alley.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					NewMeeting(t, p, f, w, s, participants, Activity.Location.ALLEY);
				}
			});
			p.add(Alley);
		}
		...
		Back.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SelectBody(t, p, f, w, s, newParticipants);
			}
		});
		p.add(Back);
		p.validate();
	...
	public static void NewMeeting(JTextPane t, JPanel p, JFrame f, WorldState w, SaveData s, Body[] participants, Activity.Location spot) {
		...
		for (int i = 0; i < participants.length; i++) {
			if (participants[i].forsakenOwner != null) {
				...
				if (participants[0] == w.lordBody) {
					if (participants[i].forsakenOwner.rememberedBodies == null || participants[i].forsakenOwner.rememberedBodies.length == 0) {
						participants[i].forsakenOwner.rememberedBodies = new Body[]{participants[0]};
			...
			} else if (participants[i].chosenOwner != null) {
				participants[i].chosenOwner.visited = true;
				if (participants[0] == w.lordBody) {
					if (participants[i].chosenOwner.rememberedBodies == null) {
						participants[i].chosenOwner.rememberedBodies = new Body[]{participants[0]};
	...
	public static void PickTarget (JTextPane t, JPanel p, JFrame f, WorldState w) {
			...
			if (allGrabbed) {
				...
				if (allFree) {
					...
					if (duration1 < 2 && duration2 < 2) {
						...
						if (victim2 != null) {
							if (w.getRelationship(killer1.getNumber(), victim1.getNumber()) == -4 || victim1.isImpregnated() || victim1.isHypnotized() || victim1.isDrained() || victim1.isParasitized() || victim1.temptReq < 100000 || victim1.dissociationReq < 10 || victim1.negotiations > 0 || victim1.resolve < 50) {
								if (w.getRelationship(killer1.getNumber(), victim2.getNumber()) == -4 || victim2.isImpregnated() || victim2.isHypnotized() || victim2.isDrained() || victim2.isParasitized() || victim2.temptReq < 100000 || victim2.dissociationReq < 10 || victim2.negotiations > 0 || victim2.resolve < 50) {
							...
							} else if (w.getRelationship(killer1.getNumber(), victim2.getNumber()) == -4 || victim2.isImpregnated() || victim2.isHypnotized() || victim2.isDrained() || victim2.isParasitized() || victim2.temptReq < 100000 || victim2.dissociationReq < 10 || victim2.negotiations > 0 || victim2.resolve < 50) {
							...
							if (victim1.isImpregnated() || victim1.isHypnotized() || victim1.isDrained() || victim1.isParasitized() || victim1.temptReq < 100000 || victim1.dissociationReq < 10 || victim1.negotiations > 0 || victim1.resolve < 50) {
		...
		for (int i = 0; i < w.getCombatants().length; i++) {
			if (w.getCombatants()[i] != null) {
				...
				if (w.getCombatants()[i].isSurrounded() && (w.getCombatants()[i].resolve > 0 || w.finalBattle == false)) {
				...
				} else if (w.getCombatants()[i].dissociated) {
					...
					if (w.dissociationSurroundPossible() == false) {
		...
		for (int i = 0; i < 3; i++) {
			if (w.getCombatants()[i] != null) {
				if (w.finalBattle == false) {
					if (w.getCombatants()[i].dissociated == false) {
						targets++;
						targetFound = i;
					} else {
						dissociated++;
		...
		if (targets == 1) {
			...
			} else if (w.getCombatants()[0].dissociated) {
		...
		if (targets == 1 && (w.getCombatants()[1] == null || defeated == 2 || dissociated == 2)) {
			...
			for (int i = 0; i < 3; i++) {
				if (w.getCombatants()[i] != null) {
					if ((w.finalBattle == false || (w.getCombatants()[i].resolve > 0 && w.getCombatants()[i].alive)) && w.getCombatants()[i].dissociated == false) {
		...
		if (w.writePossible()) {
			if (w.getCurrentComment().length() > 0) {
				...
				if (action == 0) {
					...
					generated = "Appeal to " + targetedChosen + ".";
				} else if (action > 43) {
	...
	public static void PickAction (JTextPane t, JPanel p, JFrame f, WorldState w, Chosen c, Chosen[] initiative) {
		...
		class AppealButton extends AbstractAction {
			public AppealButton(String text, String desc) {
				super(text);
				putValue(SHORT_DESCRIPTION, desc);
			}
			public void actionPerformed(ActionEvent e) {
		...
		Action AppealAction = new AppealButton("Appeal", "Use Appeal");
		class ForsakenDefilerButton extends AbstractAction{
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (w.finalBattle && w.usedForsaken.defilerType == 5) {
					...
					//f.pack();
					p.repaint();
				} else if (w.usedForsaken.defilerType == 6) {
		...
		if (w.usedForsaken != null) {
			if (w.usedForsaken.defilerType > 0) {
				if (w.usedForsaken.defilerType == 1) {
					ForsakenDefilerName = "Penetrate";
				} else if (w.usedForsaken.defilerType == 2) {
					ForsakenDefilerName = "Force Orgasm";
				} else if (w.usedForsaken.defilerType == 3) {
					ForsakenDefilerName = "Torture";
				} else if (w.usedForsaken.defilerType == 4) {
					ForsakenDefilerName = "Broadcast";
				} else if (w.usedForsaken.defilerType == 5) {
					ForsakenDefilerName = "Tempt";
				} else if (w.usedForsaken.defilerType == 6) {
					ForsakenDefilerName = "Orgy";
				} else if (w.usedForsaken.defilerType == 7) {
					ForsakenDefilerName = "Traumatize";
				}
			}
		}
		Action ForsakenDefilerAction = new ForsakenDefilerButton(ForsakenDefilerName, "Use " + ForsakenDefilerName);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (w.getTechs()[31].isOwned()) {
					...
					if (c.getCurrentHATE() >= 10000) {
						...
						if ((c.temptReq < 100000 || c.negotiations > 0) && finalInseminated != 2) {
		...
		if (c.isDefiled()) {
			...
			if (c.getCurrentHATE() >= 10000) {
				...
				if ((c.temptReq < 100000 || c.negotiations > 0) && inseminated != 2) {
					Inseminate.setBackground(REDDISH);
				}
				Inseminate.setToolTipText("<html><center>Inflicts HATE and PLEA along with<br>FEAR, DISG, " + PAINname + ", and SHAM<br>Causes tier-2 Morality Break</center></html>");
				if (inseminated == 1) {
			...
			if (w.usedForsaken == null) {
				...
				if (w.usedForsaken.defilerType == 1 && c.currentHATE >= 10000) {
					conditionsMet = true;
				} else if (w.usedForsaken.defilerType == 2 && c.currentPLEA >= 10000) {
					conditionsMet = true;
				} else if (w.usedForsaken.defilerType == 3 && c.currentINJU >= 10000) {
					conditionsMet = true;
				} else if (w.usedForsaken.defilerType == 4 && c.currentEXPO >= 10000) {
					conditionsMet = true;
				} else if (w.usedForsaken.defilerType == 5) {
					long currentTemptReq = c.temptReq;
					if (w.finalBattle) {
					...
					if (c.currentPLEA >= currentTemptReq && c.vVirg && c.aVirg && c.cVirg == false && c.modest == false && c.ruthless == false && c.timesSlaughtered() == 0 && c.timesDetonated() == 0 && (c.temptReq < 100000 || w.finalBattle == false)) {
						conditionsMet = true;
					}
				} else if (w.usedForsaken.defilerType == 6 && (c.currentHATE >= 10000 || c.currentINJU >= 10000)) {
					...
					if (firstPartner != null && secondPartner != null) {
						if ((firstPartner.inseminated && secondPartner.inseminated) || (firstPartner.orgasming && secondPartner.orgasming) || (firstPartner.sodomized && secondPartner.sodomized) || (firstPartner.broadcasted && secondPartner.broadcasted)) {
							conditionsMet = true;
						}
					}
				} else if (w.usedForsaken.defilerType == 7) {
				...
				if (w.usedForsaken.defiling) {
					...
					ForsakenDefiler.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("9"),"pressed");
					if (w.onTrack && w.getActions().length > w.getCurrentAction() && w.getActions()[w.getCurrentAction()] == c.getNumber()*14 + 2) {
						ForsakenDefiler.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("SPACE"),"pressed");
					}
			...
			p.add(Attack);
			p.add(Taunt);
			if (w.finalBattle && c.negotiations > 0) {
				...
				Appeal.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("9"),"pressed");
				if (w.onTrack && w.getActions().length > w.getCurrentAction() && w.getActions()[w.getCurrentAction()] == 47 + c.getNumber()) {
					Appeal.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("SPACE"),"pressed");
				}
	...
	public static void EnemyTurn(JTextPane t, JPanel p, JFrame f, WorldState w, Chosen[] initiative, int progress) {
		...
		if (actorFound) {
			...
			} else if (w.getCaptureTarget() == initiative[progress] || initiative[progress].isCaptured()) {
				if (w.usedForsaken == null) {
		...
		if (w.finalBattle && w.getCast()[2] != null) {
			if (w.getCast()[0].dissociated && w.getCast()[1].dissociated && w.getCast()[2].dissociated) {
				endgame = true;
			}
		}
		if (endgame) {
	...
	public static void HandleBreaks(JTextPane t, JPanel p, JFrame f, WorldState w, JButton proceed) {
		...
		if (sceneType < 16) {
			...
			if (sceneType == 16) {
			...
			} else if (sceneType == 17) {
				for (int i = 0; i < 3; i++) {
					if (w.getCast()[i].dissociationReq < 10 && w.getCast()[i].pastDissociated == false && (w.getCast()[i].innocence > 66 || w.getCast()[i].dignity > 66)) {
						broken = w.getCast()[i];
					}
				}
				if (broken == null) {
				...
				for (int i = 0; i < 3; i++) {
					if (w.getCast()[i].negotiations > 0 && w.getCast()[i].pastNegotiated == false && (w.getCast()[i].morality > 66 || w.getCast()[i].dignity > 66)) {
						broken = w.getCast()[i];
					}
				}
				if (broken == null) {
	...
	public static void Downtime(JTextPane t, JPanel p, JFrame f, WorldState w) {
		for (int i = 0; i < 3; i++) {
			if (w.getCast()[i] != null) {
				...
				} else if (w.getCast()[i].dissociationReq < 10) {
					w.getCast()[i].pastDissociated = true;
				} else if (w.getCast()[i].negotiations > 0) {
					w.getCast()[i].pastNegotiated = true;
				}
			}
		}
		...
		for (int i = 0; i <= lastChosen; i++) {
			...
			if (w.getCast()[i].dissociated && w.getCast()[i].dissociationReq < 10) {
				...
				actionWeights[i][22] = 1000L;
			} else {
				actionWeights[i][22] = 0L;
			}
			if (w.getCast()[i].truce && w.getCast()[i].negotiations > 0) {
				for (int j = 0; j < 22; j++) {
					actionWeights[i][j] = 0L;
				}
				actionWeights[i][23] = 1000L;
			} else {
				actionWeights[i][23] = 0L;
			}
			w.getCast()[i].betraying = false;
			w.getCast()[i].dissociated = false;
			w.getCast()[i].truce = false;
	...
	public static void Shop(JTextPane t, JPanel p, JFrame f, WorldState w) {
		...
		if ((w.getDay() > 50 - w.eventOffset*3 || w.getEarlyCheat() || w.cheater) && (w.campaign == false || w.getEarlyCheat())) {
		...
		for (int i = 0; i < 3 && w.getTechs()[0].isOwned(); i++) {
			if (w.getCast()[i] != null && w.getCast()[i].negotiatePossible(w)) {
				Profiles.setBackground(PURPLISH);
			}
		}
		p.add(Profiles);
		if (w.getTechs()[3].isOwned() || w.truceEnforced()) {
			...
			if (w.getHarem().length > 0 || (w.loopComplete == false && w.truceEnforced() == false)) {
				p.add(CustomBody);
		...
		if (w.loopComplete == false && w.truceEnforced() == false) {
			p.add(NextBattle);
			...
			for (int i = 0; i < w.nextCities.length; i++) {
				...
				while (difficultyScore < w.nextCities[i].loops*10) {
					...
					if (difficultyType < 11.0/36.0 && clampRemoval < 1660) {
						...
						difficultyScore += increase;
						while (increase > 0 && w.earlyCheat == false) {
		...
		if (w.getTechs()[0].isOwned() && w.loopComplete == false) {
			...
			for (int i = 0; i < 3 && w.loopComplete == false; i++) {
				if (w.getCast()[i] != null) {
						...
						public void actionPerformed(ActionEvent e) {
							...
							Approach.addActionListener(new ActionListener() {
								public void actionPerformed(ActionEvent e) {
									...
									newParticipants[0].imprisoned = false;
									SelectBody(t, p, f, w, w.save, newParticipants);
								}
							});
							if (w.day > 1 && w.getCast()[thisChosen].visited == false) {
								if (w.getCast()[thisChosen].negotiatePossible(w)) {
									Approach.setBackground(PURPLISH);
								}
								p.add(Approach);
							}
					...
					if (w.getCast()[i].negotiatePossible(w)) {
	...
	public static void ViewAchievements(JTextPane t, JPanel p, JFrame f, WorldState w, int page) {
		...
		for (int i = page*5; i < page*5+5 && i < w.achievementSeen.length; i++) {
			...
			if (i == 0) {
				...
				description += "Chosen successfully Negotiated with: " + w.achievementHeld(i)[1] + "\n";
				description += "Level: " + w.achievementHeld(i)[0];
				if (w.achievementHeld(i)[0] == 0) {
					description += " (Next: 2 Negotiated)\nBonus: N/A";
				} else if (w.achievementHeld(i)[0] == 1) {
					description += " (Next: 5 Negotiated)\nBonus: Appeal deals double Resolve damage";
				} else if (w.achievementHeld(i)[0] == 2) {
					description += " (Next: 12 Negotiated)\nBonus: Appeal deals triple Resolve damage";
				} else if (w.achievementHeld(i)[0] == 3) {
					description += " (Next: 30 Negotiated)\nBonus: Appeal deals quadruple Resolve damage";
				} else if (w.achievementHeld(i)[0] == 4) {
					description += " (Next: 80 Negotiated)\nBonus: Appeal deals quintuple Resolve damage";
				} else {
					description += "\nBonus: Appeal deals sextuple Resolve damage";
				}
				description += "\nA reputation for being reasonable can also be useful for a Demon Lord.  As word spreads that Chosen can influence you by more peaceful methods, the idea of fighting will become less attractive.";
			} else if (i == 8) {
			...
			while (i < saves.getSaves().length && j < 4) {
				...
				if (saves.getSaves()[i].campaign) {
					if (saves.getSaves()[i].earlyCheat) {
						w.greenAppend(t, displayedName + " [Loop " + (saves.getSaves()[i].loops+1) + ": " + saves.getSaves()[i].cityName);
			...
			for (int j = 0; j < 3; j++) {
				if (w.getCast()[j] != null) {
					...
					if (w.usedForsaken.knowsPersonally(w.getCast()[j])) {
						w.append(t, "Personal (8 rounds, +25% damage)");
					} else if (w.usedForsaken.obsessedWith(w.getCast()[j])) {
						w.append(t, "Obsessed (8 rounds, +25% damage)");
					} else if (compatibility >= 8) {
						w.append(t, "Excellent (8 rounds)");
					} else if (compatibility == 7) {
	...
	public static void DefeatScene(JTextPane t, JPanel p, JFrame f, WorldState w) {
		...
		if (escaped[2] != null) {
			...
			high.say(t, "\"");
			changePortrait(high.convertGender(), high.type, false, false, w, new String[]{high.mainName, mid.mainName, low.mainName, null, null}, 0, Project.Emotion.FOCUS, Project.Emotion.FOCUS);
			changePortrait(mid.convertGender(), mid.type, false, false, w, new String[]{high.mainName, mid.mainName, low.mainName, null, null}, 1, Project.Emotion.FOCUS, Project.Emotion.FOCUS);
			changePortrait(low.convertGender(), low.type, false, false, w, new String[]{high.mainName, mid.mainName, low.mainName, null, null}, 2, Project.Emotion.FOCUS, Project.Emotion.FOCUS);
			if (w.getRelationship(high.getNumber(), mid.getNumber()) >= 0) {
				if (w.getRelationship(high.getNumber(), low.getNumber()) >= 0) {
					...
					if (w.getRelationship(mid.getNumber(), low.getNumber()) >= 0) {
						...
						changePortrait(mid.convertGender(), mid.type, false, false, w, new String[]{high.mainName, mid.mainName, low.mainName, null, null}, 1, Project.Emotion.ANGER, Project.Emotion.ANGER);
						mid.say(t, "I'm ready!  You'd better not screw it up for us, " + low.getMainName() + "!\"\n\n");
						low.say(t, "\"I-I won't let you down, " + high.getMainName() + "!");
					}
				} else {
					changePortrait(high.convertGender(), high.type, false, false, w, new String[]{high.mainName, mid.mainName, low.mainName, null, null}, 0, Project.Emotion.ANGER, Project.Emotion.ANGER);
					...
					if (w.getRelationship(mid.getNumber(), low.getNumber()) >= 0) {
						...
						changePortrait(low.convertGender(), low.type, false, false, w, new String[]{high.mainName, mid.mainName, low.mainName, null, null}, 2, Project.Emotion.ANGER, Project.Emotion.ANGER);
				...
				if (w.getRelationship(high.getNumber(), low.getNumber()) >= 0) {
					...
					if (w.getRelationship(mid.getNumber(), low.getNumber()) >= 0) {
						...
						changePortrait(low.convertGender(), low.type, false, false, w, new String[]{high.mainName, mid.mainName, low.mainName, null, null}, 2, Project.Emotion.FEAR, Project.Emotion.FEAR);
					} else {
			...
			changePortrait(first.convertGender(), first.type, false, false, w, new String[]{first.mainName, second.mainName, null, null, null}, 0, Project.Emotion.FOCUS, Project.Emotion.FOCUS);
			if (w.getRelationship(first.getNumber(), second.getNumber()) >= 0) {
				changePortrait(second.convertGender(), second.type, false, false, w, new String[]{first.mainName, second.mainName, null, null, null}, 1, Project.Emotion.FOCUS, Project.Emotion.FOCUS);
				...
				changePortrait(second.convertGender(), second.type, false, false, w, new String[]{first.mainName, second.mainName, null, null, null}, 1, Project.Emotion.FEAR, Project.Emotion.FEAR);
			...
			escaped[0].say(t, "\n\n\"");
			changePortrait(escaped[0].convertGender(), escaped[0].type, false, false, w, new String[]{escaped[0].mainName, null, null, null, null}, 0, Project.Emotion.SHAME, Project.Emotion.SHAME);
			if (escaped[0].getConfidence() > 66) {
				changePortrait(escaped[0].convertGender(), escaped[0].type, false, false, w, new String[]{escaped[0].mainName, null, null, null, null}, 0, Project.Emotion.STRUGGLE, Project.Emotion.STRUGGLE);
						...
						if (forsaken > i) {
							...
							for (int j = 0; j < w.getHarem().length; j++) {
								for(int k = 0; k < w.getHarem()[j].otherChosen.length; k++) {
									...
									if (alreadyThere == false && w.getHarem()[j].otherChosen[k].equals(corrupted[i])) {
			...
			for (int i = 0; i < w.getHarem().length; i++) {
				if (w.getHarem()[i] != tantruming) {
					...
					if (w.getHarem()[i].others != null) {
						...
						w.getHarem()[i].forsakenRelations = new Forsaken.Relationship[]{null};
					}
				}
			}
			if (w.getHarem().length > 1) {
