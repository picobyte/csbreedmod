...
public class BreedmodVariables {
	...
	public String printNameValuePair(){
		...
		output = output.concat("analSensitivity is " + String.valueOf(this.analSensitivity) + "\n");
		output = output.concat("analCapacity is " + String.valueOf(this.analCapacity) + "\n");
		output = output.concat("analTightness is " + String.valueOf(this.analTightness) + "\n");
		output = output.concat("analLubrication is " + String.valueOf(this.analLubrication) + "\n");
		output = output.concat("analHoldsInCum is " + String.valueOf(this.analHoldsInCum) + "\n");
		output = output.concat("vagSensitivity is " + String.valueOf(this.vagSensitivity) + "\n");
		output = output.concat("vagCapacity is " + String.valueOf(this.vagCapacity) + "\n");
		output = output.concat("vagTightness is " + String.valueOf(this.vagTightness) + "\n");
		output = output.concat("vagLubrication is " + String.valueOf(this.vagLubrication) + "\n");
		output = output.concat("vagHoldsInCum is " + String.valueOf(this.vagHoldsInCum) + "\n");
		output = output.concat("wombCapacity is " + String.valueOf(this.wombCapacity) + "\n");
		output = output.concat("cervixSensitivity is " + String.valueOf(this.cervixSensitivity) + "\n");
		output = output.concat("cervixPenetration is " + String.valueOf(this.cervixPenetration) + "\n");
		output = output.concat("girthQueen is " + String.valueOf(this.girthQueen) + "\n");
		output = output.concat("lengthQueen is " + String.valueOf(this.lengthQueen) + "\n");
		output = output.concat("ovulationFrequency is " + String.valueOf(this.ovulationFrequency) + "\n");
		output = output.concat("ovulationQuantity is " + String.valueOf(this.ovulationQuantity) + "\n");
		output = output.concat("pregnancyCraving is " + String.valueOf(this.pregnancyCraving) + "\n");
		output = output.concat("pregnancyRate is " + String.valueOf(this.pregnancyRate) + "\n");
		output = output.concat("goesIntoHeat is " + String.valueOf(this.goesIntoHeat) + "\n");
		output = output.concat("pheremones is " + String.valueOf(this.pheremones) + "\n");
		output = output.concat("hipSize is " + String.valueOf(this.hipSize) + "\n");
		output = output.concat("hipShape is " + String.valueOf(this.hipShape) + "\n");
		output = output.concat("buttSize is " + String.valueOf(this.buttSize) + "\n");
		output = output.concat("buttShape is " + String.valueOf(this.buttShape) + "\n");
		output = output.concat("boobSize is " + String.valueOf(this.boobSize) + "\n");
		output = output.concat("boobShape is " + String.valueOf(this.boobShape) + "\n");
		output = output.concat("boobSensitivity is " + String.valueOf(this.boobSensitivity) + "\n");
		output = output.concat("milkProduction is " + String.valueOf(this.milkProduction) + "\n");
		output = output.concat("milkType is " + String.valueOf(this.milkType) + "\n");
		output = output.concat("gagReflex is " + String.valueOf(this.gagReflex) + "\n");
		output = output.concat("throatSensitivity is " + String.valueOf(this.throatSensitivity) + "\n");
		output = output.concat("cumFlavorDesire is " + String.valueOf(this.cumFlavorDesire) + "\n");
		output = output.concat("cumDependency is " + String.valueOf(this.cumDependency) + "\n");
		output = output.concat("facialBeauty is " + String.valueOf(this.facialBeauty) + "\n");
		output = output.concat("facialArchetype is " + String.valueOf(this.facialArchetype) + "\n");
		output = output.concat("height is " + String.valueOf(this.height) + "\n");
		output = output.concat("waistWidth is " + String.valueOf(this.waistWidth) + "\n");
		output = output.concat("musculature is " + String.valueOf(this.musculature) + "\n");
		output = output.concat("fatPercentage is " + String.valueOf(this.fatPercentage) + "\n");
		output = output.concat("skinColor is " + String.valueOf(this.skinColor) + "\n");
		output = output.concat("flexibility is " + String.valueOf(this.flexibility) + "\n");
		output = output.concat("hairColor is " + String.valueOf(this.hairColor) + "\n");
		output = output.concat("hairLength is " + String.valueOf(this.hairLength) + "\n");
		output = output.concat("growsHairBelowNeck is " + String.valueOf(this.growsHairBelowNeck) + "\n");
		output = output.concat("intelligence is " + String.valueOf(this.intelligence) + "\n");
		output = output.concat("ego is " + String.valueOf(this.ego) + "\n");
		output = output.concat("submissiveness is " + String.valueOf(this.submissiveness) + "\n");
		output = output.concat("naturalMasochism is " + String.valueOf(this.naturalMasochism) + "\n");
		output = output.concat("libido is " + String.valueOf(this.libido) + "\n");
		output = output.concat("incestResistance is " + String.valueOf(this.incestResistance) + "\n");
		output = output.concat("cumProduction is " + String.valueOf(this.cumProduction) + "\n");
		output = output.concat("cumPotency is " + String.valueOf(this.cumPotency) + "\n");
		output = output.concat("cumTaste is " + String.valueOf(this.cumTaste) + "\n");
		output = output.concat("cumIntoxication is " + String.valueOf(this.cumIntoxication) + "\n");
		output = output.concat("cumKiller is " + String.valueOf(this.cumKiller) + "\n");
		output = output.concat("dickLength is " + String.valueOf(this.dickLength) + "\n");
		output = output.concat("dickGirth is " + String.valueOf(this.dickGirth) + "\n");
		output = output.concat("testicleSize is " + String.valueOf(this.testicleSize) + "\n");
